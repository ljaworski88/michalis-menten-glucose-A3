...
} else if (Sys.info()[['nodename']] == 'DESKTOP-075G5RC'){
...
# the file containing the data, produced using the curve_tester.py script 
# which relies on the gcrcurvefit.py library
# Km(mM), Vmax(mmol/million cells/hr) in imported file
